...
import SnapScrollContainer from "@/components/features/SnapScrollContainer";
...
export default function HomePageClient() {
    ...
    return (
        <SnapScrollContainer resistanceThreshold={80}>
            <div className="bg-background text-primary">
                {/* Hero Section */}
                <section className="snap-section relative overflow-hidden bg-surface min-h-screen flex flex-col justify-center">
                ...
                {/* 世界特色 Section */}
                <section className="snap-section bg-background min-h-screen flex flex-col justify-center py-16">
                ...
                {/* 角色預覽 Section */}
                <section className="snap-section bg-surface min-h-screen flex flex-col justify-center py-16">
                    <div className="container-base">
                ...
                {/* Footer - 也作為一個吸附區塊，但不強制佔滿整個視窗 */}
                <section className="snap-section !min-h-0">
                    <Footer />
                </section>
            </div>
        </SnapScrollContainer>
